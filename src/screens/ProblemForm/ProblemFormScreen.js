...
const ProblemFormScreen = () => {
  ...
  let initialPythonTemplate = JSON.parse(
    localStorage.getItem("pythonTemplate")
  );
  ...
  useEffect(() => {
    ...
    let inputOutputsIniciales = JSON.parse(
      localStorage.getItem("inputOutputs")
    );
    ...
    if (activeStep === 2) {
      ...
      if (activeStep === 0) {
        ...
        if (
          ...
          validateCases =
            validateCases +
            "Debes seleccionar una dificultad para el problema.\n";
        }
        if (
          ...
          validateCases =
            validateCases +
            "Debes agregar una descripcion para el problema de al menos 8 caracteres.\n";
        }
        if (
          ...
          validateCases =
            validateCases + "Debes agregar una solucion para el problema.\n";
        }
        ...
        if (
          ...
          validateCases =
            validateCases +
            "Debes agregar un template al problema en codigo Java.\n";
        }
        if (
          problemInfo.templateCode === undefined ||
          ...
          validateCases =
            validateCases +
            "Debes agregar un template al problema en codigo Python.\n";
        }
      }
      if (validateCases.trim().replace("\n", "") !== "") {
        alert(validateCases);
  ...
  const agregarInputOutput = (inputOutput) => {
    setInputOutputs([...inputOutputs, inputOutput]);
  };
